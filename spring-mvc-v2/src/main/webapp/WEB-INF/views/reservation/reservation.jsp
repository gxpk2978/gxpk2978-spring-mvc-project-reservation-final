...
<form method="get" action="javascript:void(0);">
    <input type="submit" value="조회하기" onclick="redirectToLogin()">
</form>
    </div>
...
function redirectToLogin() {
    ...
    var customerId = url.substring(url.lastIndexOf('/') + 1); // URL에서 마지막 '/' 이후의 문자열 추출 (ID 부분)
    window.location.href = "/reservation/reservationDetail/"+customerId;
}
